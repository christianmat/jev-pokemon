...
export const MILESTONES: Milestone[] = [
  ...
  { id: 'brock', goal: 'Defeat Brock, the Pewter City Gym Leader (Rock/Ground Pokémon, Lv12-14). Water, Grass and Fighting moves are strong against him; Fire and Normal moves are weak against Rock.', maps: ['PEWTER_GYM'], done: badge(0), level: 14 },
  ...
  { id: 'surge', goal: 'Defeat Lt. Surge at the Vermilion City Gym (Electric type; Ground moves are strong). A small tree blocks the gym entrance.', maps: ['VERMILION_GYM'], done: badge(2), level: 24 },
  ...
  { id: 'erika', goal: 'Defeat Erika at the Celadon City Gym (Grass type; Fire, Ice, Flying moves are strong).', maps: ['CELADON_GYM'], done: badge(3), level: 29 },
