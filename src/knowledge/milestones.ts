...
export const MILESTONES: Milestone[] = [
  ...
  { id: 'brock', goal: 'Defeat Brock, the Pewter City Gym Leader (Rock/Ground Pokémon, Lv12-14). Water, Grass and Fighting moves are strong against him; Fire and Normal moves are weak against Rock. Wild Pokémon in Viridian Forest and Routes 2/22 can be caught to add team members.', maps: ['PEWTER_GYM'], done: badge(0), level: 14 },
  ...
  { id: 'misty', goal: 'Defeat Misty, the Cerulean City Gym Leader (Water type). Electric or Grass moves are strong against her.', maps: ['CERULEAN_GYM'], done: badge(1), level: 21 },
  ...
  { id: 'surge', goal: 'Defeat Lt. Surge at the Vermilion City Gym (Electric type; Ground moves are strong). A Cut tree blocks the gym entrance — teach Cut and use it.', maps: ['VERMILION_GYM'], done: badge(2), level: 24 },
  ...
  { id: 'erika', goal: 'Defeat Erika at the Celadon City Gym (Grass type; Fire, Ice, Flying moves are strong). Cut the tree to enter.', maps: ['CELADON_GYM'], done: badge(3), level: 29 },
  ...
  { id: 'koga', goal: 'Defeat Koga at the Fuchsia City Gym (Poison type; Psychic and Ground moves are strong).', maps: ['FUCHSIA_GYM'], done: badge(4), level: 43 },
  ...
  { id: 'sabrina', goal: 'Defeat Sabrina at the Saffron City Gym (Psychic type; Bug moves are strong, teleport pads connect the rooms).', maps: ['SAFFRON_GYM'], done: badge(5), level: 43 },
